...
<div
	...
	<div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
		...
		<h2 class="m-3 mx-auto text-center fw-bold">Video Moderation with Cloudinary</h2>
		<p class="m-4">
			Video moderation helps you share highly engaging and effective video content while protecting your brand, customers and profits.
		</p>
